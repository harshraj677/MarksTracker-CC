...
export default async function StudentPage({ params }: PageProps) {
  ...
  return (
    <main className="min-h-screen bg-white flex items-center justify-center p-4 sm:p-6 relative overflow-hidden">
      ...
      <div className={`absolute top-0 left-0 w-[600px] h-[600px] ${isBlue ? "bg-sky-50" : "bg-emerald-50"} rounded-full -translate-y-1/2 -translate-x-1/3`} />
      <div className={`absolute bottom-0 right-0 w-[400px] h-[400px] ${isBlue ? "bg-blue-50" : "bg-teal-50"} rounded-full translate-y-1/2 translate-x-1/3`} />
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-white rounded-2xl shadow-xl shadow-gray-200/60 border border-gray-100 p-6 sm:p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-xs mt-0.5">Enter your USN to view your results</p>
          </div>

          <UsnLookupForm slug={slug} color={subject.color} />
        </div>
      </div>
    </main>
  );
